...
from .utils import hex_color_validator
...
class Ingredient(models.Model):
    ...
    name = models.CharField('Имя ингредиента', max_length=200)
...
class Recipe(models.Model):
    ...
    name = models.CharField('Имя рецепта', max_length=30)
...
class FavoritesAndShopping(models.Model):
    """Базовая модель для моделей Favorite и ShoppingList."""
